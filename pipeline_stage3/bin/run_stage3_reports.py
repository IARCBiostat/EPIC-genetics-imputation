...
BIN_DIR = REPO_ROOT / "pipeline_stage3" / "bin"
if str(BIN_DIR) not in sys.path:
    sys.path.insert(0, str(BIN_DIR))

from stage3_reports import TASK_SEQUENCE, run_task  # noqa: E402


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Create stage-3 figures, tables, flags, and report assets.")
