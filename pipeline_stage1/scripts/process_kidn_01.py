...
PREFIX = 'Kidn_01'
STUDY_ID = 'Kidn_01'
RAW_REL = 'Kidney/Kidn_01/Data_Received/Kidney_GWAS1_beforeQC'
MANIFEST_REL = 'Kidney/Kidn_01/Chip_files/Human610-Quadv1_B-b36.strand'
MANIFEST_FLAGS = '-c 1 -p 2 -n 0 -a 5 -sp 4'
BUILD = '36'
ID_LINK_REL = 'Kidney/Kidn_01/Data_Received/Link_Ids_Kidney.csv'
