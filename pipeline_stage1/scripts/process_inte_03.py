...
PREFIX = 'Inte_03'
STUDY_ID = 'Inte_03'
RAW_REL = 'Interact/Inte_03/Data_Received/InterAct_HumanCoreExome-24v1_cleaned'
...
ID_LINK_REL = None
ID_FLAGS = '-q'
QC_REFERENCE_PREFIX = 'Inte_03'
PRE = {}
PART1 = {'neg': 'exclude_PM', 'chrpos': 'exclude', 'alleles': 'exclude'}
COMPLETION = {'chr': 'move', 'pos': 'move', 'strand': 'move', 'alleles': 'search'}
