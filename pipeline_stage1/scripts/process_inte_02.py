...
PREFIX = 'Inte_02'
STUDY_ID = 'Inte_02'
RAW_REL = 'genetics/Inte_02/Data_Received/InterAct_HumanCoreExome-12v1_cleaned'
MANIFEST_REL = 'genetics/Inte_02/Chip_files/HumanCoreExome-12-v1-0-D.csv'
MANIFEST_FLAGS = '-c 9 -p 10 -n 1 -sp 20 -a 3 -st 2 -sf 0 -b 8 -nlh 8 -nlt 24'
BUILD = '37'
ID_LINK_REL = None
ID_FLAGS = '-q'
QC_REFERENCE_PREFIX = 'Inte_02'
PRE = {}
