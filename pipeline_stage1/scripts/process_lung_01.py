...
PREFIX = 'Lung_01'
STUDY_ID = 'Lung_01'
RAW_REL = 'Lung/Lung_01/Data_Received/Lung_beforeQC'
MANIFEST_REL = 'Lung/Lung_01/Chip_files/OncoArray-500K-C.csv'
MANIFEST_FLAGS = '-t {data_root}/Lung/Lung_01/Chip_files/OncoArray-500K-C-auxiliary-file.txt -c 9 -p 10 -n 1 -a 3 -sp 20 -sf 0 -st 2 -b 8 -nlh 8 -nlt 24'
BUILD = '37'
ID_LINK_REL = 'Lung/Lung_01/Data_Received/Duplicates_fakeIDs_correspondance_n109.csv'
