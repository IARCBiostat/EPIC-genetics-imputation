...
PREFIX = 'Brea_02'
STUDY_ID = 'Brea_02'
RAW_REL = 'Breast/Brea_02_Onco/Data_Received/epic_bed_onco'
MANIFEST_REL = 'Breast/Brea_02_Onco/Chip_files/OncoArray-500K-C.csv'
MANIFEST_FLAGS = '-t {data_root}/Breast/Brea_02_Onco/Chip_files/OncoArray-500K-C-auxiliary-file.txt -c 9 -p 10 -n 1 -a 3 -sp 20 -sf 0 -st 2 -b 8 -nlh 8 -nlt 24'
BUILD = '37'
ID_LINK_REL = 'Breast/Brea_02_Onco/Data_Received/EPIC-BPC3_OncoArray_dataReturn_samplelist_02072018.csv'
