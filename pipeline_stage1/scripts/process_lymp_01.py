...
PREFIX = 'Lymp_01'
STUDY_ID = 'Lymp_01'
RAW_REL = 'genetics/Lymp_01/Data_Received/NHL_Epic'
MANIFEST_REL = 'genetics/Lymp_01/Chip_files/HumanOmniExpress-12v1_A.csv'
MANIFEST_FLAGS = '-c 11 -p 12 -n 1 -a 3 -sp 21 -sf 0 -st 2 -b 10 -nlh 1'
BUILD = '36'
ID_LINK_REL = 'genetics/Lymp_01/Data_Received/EPIC.to.IARC.11.14.2018_Lymphoma.csv'
