...
PREFIX = 'Lymp_01'
STUDY_ID = 'Lymp_01'
RAW_REL = 'Lymphoma/Lymp_01/Data_Received/NHL_Epic'
MANIFEST_REL = 'Lymphoma/Lymp_01/Chip_files/HumanOmniExpress-12v1_A.csv'
MANIFEST_FLAGS = '-c 11 -p 12 -n 1 -a 3 -sp 21 -sf 0 -st 2 -b 10 -nlh 1'
BUILD = '36'
ID_LINK_REL = 'Lymphoma/Lymp_01/Data_Received/EPIC.to.IARC.11.14.2018_Lymphoma.csv'
ID_FLAGS = '-s 0 -e 3 -nlh 1 -q'
QC_REFERENCE_PREFIX = 'Lymp_01'
PRE = {}
PART1 = {'neg': 'exclude_TB', 'chrpos': 'exclude', 'alleles': 'exclude'}
COMPLETION = {'chr': 'move', 'pos': 'move', 'strand': 'flip_tb_pm', 'alleles': 'search', 'subversion_rel': 'Lymp_01_SNP_build_36.2.txt'}
PART2_BUILD35_REL = 'Lymp_01_SNP_build_35.txt'
