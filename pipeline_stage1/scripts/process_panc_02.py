...
PREFIX = 'Panc_02'
STUDY_ID = 'Panc_02'
RAW_REL = 'Pancreas/Panc_02_PS3/Data_Received/P3'
MANIFEST_REL = 'Pancreas/Panc_02_PS3/Chip_files/HumanOmniExpress-12v1_A.csv'
MANIFEST_FLAGS = '-c 11 -p 12 -n 1 -a 3 -sp 21 -sf 0 -st 2 -b 10 -nlh 1'
BUILD = '36'
ID_LINK_REL = 'Pancreas/Panc_02_PS3/Data_Received/EPIC.to.IARC.11.14.2018_Panscan3.csv'
