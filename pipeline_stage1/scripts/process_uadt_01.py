...
PREFIX = 'Uadt_01'
STUDY_ID = 'Uadt_01'
RAW_REL = 'genetics/Uadt_01/Data_Received/UADT_beforeQC'
MANIFEST_REL = 'genetics/Uadt_01/Chip_files/OncoArray-500K-C.csv'
MANIFEST_FLAGS = '-t {data_root}/genetics/Uadt_01/Chip_files/OncoArray-500K-C-auxiliary-file.txt -c 9 -p 10 -n 1 -a 3 -sp 20 -sf 0 -st 2 -b 8 -nlh 8 -nlt 24'
BUILD = '37'
ID_LINK_REL = None
ID_FLAGS = ''
QC_REFERENCE_PREFIX = 'Uadt_01'
PRE = {'ab_translate': True, 'ab_txt_rel': 'genetics/Uadt_01/Chip_files/OncoArray-500K-C-auxiliary-file.txt'}
PART1 = {'neg': 'move', 'chrpos': 'exclude', 'alleles': 'move_all'}
COMPLETION = {'chr': 'move', 'pos': 'move', 'strand': 'flip_pm', 'alleles': 'search'}
