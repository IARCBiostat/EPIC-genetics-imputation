...
PREFIX = 'Pros_04'
STUDY_ID = 'Pros_04'
RAW_REL = 'genetics/Pros_04_P160555/Data_Received/Pros_HtsGsa'
MANIFEST_REL = 'genetics/Pros_04_P160555/Chip_files/GSA_SNP_List.csv'
MANIFEST_FLAGS = '-c 9 -p 10 -n 1 -a 3 -sp 20 -sf 0 -st 2 -b 8 -nlh 8 -nlt 24'
BUILD = '37'
ID_LINK_REL = 'genetics/Pros_04_P160555/Data_Received/Link_Ids_Pros_HtsGsa.csv'
