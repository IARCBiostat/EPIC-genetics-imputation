...
PREFIX = 'Stom_01'
STUDY_ID = 'Stom_01'
RAW_REL = 'Stomach/Stom_01/Data_Received/GWAS_EPIC/EPIC/subjects_allloci'
MANIFEST_REL = 'Stomach/Stom_01/Chip_files/Human660W-Quad_v1_H.csv'
MANIFEST_FLAGS = '-c 9 -p 10 -n 1 -a 3 -sf 0 -st 2 -sp 21 -b 8 -nlh 8 -nlt 24'
BUILD = '36'
ID_LINK_REL = 'Stomach/Stom_01/Data_Received/GWAS_EPIC/EPIC/subject_mapping.txt'
