...
PREFIX = 'Ovar_01'
STUDY_ID = 'Ovar_01'
RAW_REL = 'genetics/Ovar_01/Data_Received_2022/epc_plink'
MANIFEST_REL = 'genetics/Ovar_01/Chip_files/OncoArray-500K-C.csv'
MANIFEST_AUX_REL = 'genetics/Ovar_01/Chip_files/OncoArray-500K-C-auxiliary-file.txt'
MANIFEST_FLAGS = '-c 9 -p 10 -n 1 -a 3 -sp 20 -sf 0 -st 2 -b 8 -nlh 8 -nlt 24'
BUILD = '37'
ID_LINK_REL = 'genetics/Ovar_01/Data_Received_2021/Link_Ids_Ovar_01Onco.csv'
ID_FLAGS = '-s 1 -e 2 -nlh 2 -q'
QC_REFERENCE_PREFIX = 'Ovar_01'
PRE = {}
PART1 = {'neg': 'exclude_TB', 'chrpos': 'exclude', 'alleles': 'exclude'}
COMPLETION = {'chr': 'move', 'pos': 'move', 'strand': 'flip_tb_pm', 'alleles': 'search'}
...
def main() -> None:
    ...
    manifest_read = f"{q(data_root / MANIFEST_REL)} -t {q(data_root / MANIFEST_AUX_REL)} {render_flags(MANIFEST_FLAGS, data_root)}".strip()
