...
PREFIX = 'Ovar_01'
STUDY_ID = 'Ovar_01'
RAW_REL = 'Ovary/Ovar_01/Data_Received_2022/epc_plink'
MANIFEST_REL = 'Ovary/Ovar_01/Chip_files/OncoArray-500K-C.csv'
MANIFEST_FLAGS = '-t {data_root}/Ovary/Ovar_01/Chip_files/OncoArray-500K-C-auxiliary-file.txt -c 9 -p 10 -n 1 -a 3 -sp 20 -sf 0 -st 2 -b 8 -nlh 8 -nlt 24'
BUILD = '37'
ID_LINK_REL = 'Ovary/Ovar_01/Data_Received_2021/Link_Ids_Ovar_01Onco.csv'
