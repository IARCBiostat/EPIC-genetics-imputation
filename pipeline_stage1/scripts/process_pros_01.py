...
PREFIX = 'Pros_01'
STUDY_ID = 'Pros_01'
RAW_REL = 'Prostate/Pros_01_Bpc3/Data_Received/cleaned_BPC3_AdvCaP_EPIC'
MANIFEST_REL = 'Prostate/Pros_01_Bpc3/Chip_files/Human610-Quadv1_H.csv'
MANIFEST_FLAGS = '-c 9 -p 10 -n 1 -a 3 -sf 0 -st 2 -sp 21 -b 8 -nlh 8 -nlt 24'
BUILD = '36'
ID_LINK_REL = 'Prostate/Pros_01_Bpc3/Data_Received/BPC3_ID_Link_File.txt'
