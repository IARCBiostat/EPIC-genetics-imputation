...
PREFIX = 'Kidn_02'
STUDY_ID = 'Kidn_02'
RAW_REL = 'genetics/Kidn_02/Data_Received/Kidney_GWAS2_beforeQC'
MANIFEST_REL = 'genetics/Kidn_02/Chip_files/InfiniumOmni5-4v1-2_A1.csv'
MANIFEST_FLAGS = '-t {data_root}/genetics/Kidn_02/Chip_files/InfiniumOmni5-4v1-2_A1_b144_rsids.txt -c 9 -p 10 -n 1 -a 3 -sp 20 -sf 0 -st 2 -b 8 -nlh 8 -nlt 24'
BUILD = '37'
ID_LINK_REL = None
ID_FLAGS = ''
QC_REFERENCE_PREFIX = 'Kidn_02'
PRE = {}
PART1 = {'neg': 'exclude_PM', 'chrpos': 'exclude', 'alleles': 'exclude'}
COMPLETION = {'chr': 'move', 'pos': 'search', 'strand': 'move', 'alleles': 'search', 'txt_rel': 'genetics/Kidn_02/Chip_files/InfiniumOmni5-4v1-2_A1_b144_rsids.txt'}
