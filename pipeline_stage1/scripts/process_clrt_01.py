...
PREFIX = 'Clrt_01'
STUDY_ID = 'Clrt_01'
RAW_REL = 'genetics/Clrt_01_Gecco/Data_Received/Data_Extracted/clrt_gecco_geno'
MANIFEST_REL = 'genetics/Clrt_01_Gecco/Chip_files/HumanOmniExpressExome-8-v1-2-B.csv'
MANIFEST_FLAGS = '-c 9 -p 10 -n 1 -a 3 -sp 20 -sf 0 -st 2 -b 8 -nlh 8 -nlt 24'
BUILD = '37'
ID_LINK_REL = 'genetics/Clrt_01_Gecco/Data_Received/EPIC_samplefile.tsv'
...
def main() -> None:
    ...
    manifest_read = f"{q(data_root / MANIFEST_REL)} {render_flags(MANIFEST_FLAGS, data_root)}".strip()
