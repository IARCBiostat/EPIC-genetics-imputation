...
PREFIX = 'Pros_02'
STUDY_ID = 'Pros_02'
RAW_REL = 'genetics/Pros_02_Icogs/Data_Received/iCOGS'
MANIFEST_REL = 'genetics/Pros_02_Icogs/Chip_files/icogs_snp_list.csv'
MANIFEST_FLAGS = '-c 3 -p 5 -n 1 -a 10 -sp 7 -nlh 1'
BUILD = '37'
ID_LINK_REL = 'genetics/Pros_02_Icogs/Data_Received/iCOGS_ID_Link_File.txt'
