...
PREFIX = 'Ecvd_01'
STUDY_ID = 'Ecvd_01'
RAW_REL = 'Epic_Cvd/Ecvd_01/Data_Received/EPICCVD_HumanCoreExome_CVD_cases_for_IARC'
MANIFEST_REL = 'Interact/Inte_03/Chip_files/HumanCoreExome-24v1-0-A.csv'
MANIFEST_FLAGS = '-c 9 -p 10 -n 1 -sp 20 -a 3 -st 2 -sf 0 -b 8 -nlh 8 -nlt 24'
BUILD = '37'
ID_LINK_REL = 'Epic_Cvd/Ecvd_01/Data_Received/EPICCVD_HumanCoreExome_CVDcases_for_IARC_link_to_idepic.txt'
ID_FLAGS = '-nlh 1 -s 1 -e 0 -q'
QC_REFERENCE_PREFIX = 'Ecvd_01'
PRE = {}
