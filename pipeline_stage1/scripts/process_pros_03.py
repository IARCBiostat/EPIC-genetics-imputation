...
PREFIX = 'Pros_03'
STUDY_ID = 'Pros_03'
RAW_REL = 'genetics/Pros_03_Onco/Data_Received/OncoArray'
MANIFEST_REL = 'genetics/Pros_03_Onco/Chip_files/OncoArray-500K-C.csv'
MANIFEST_FLAGS = '-t {data_root}/genetics/Pros_03_Onco/Chip_files/OncoArray-500K-C-auxiliary-file.txt -c 9 -p 10 -n 1 -a 3 -sp 20 -sf 0 -st 2 -b 8 -nlh 8 -nlt 24'
BUILD = '37'
ID_LINK_REL = 'genetics/Pros_03_Onco/Data_Received/Oncoarray_ID_Link_File.csv'
ID_FLAGS = '-s 0 -e 2 -nlh 1'
QC_REFERENCE_PREFIX = 'Pros_03'
PRE = {'reset_positions': True, 'second_qc_mode': 'w'}
PART1 = {'neg': 'exclude_TB', 'chrpos': 'exclude', 'alleles': 'exclude'}
COMPLETION = {'chr': 'search', 'pos': 'search', 'strand': 'flip_tb_pm', 'alleles': 'search'}
