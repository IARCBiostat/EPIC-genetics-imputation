...
PREFIX = 'Glbd_01'
STUDY_ID = 'Glbd_01'
RAW_REL = 'Gallbladder/Glbd_01/Data_Received/EPIC'
MANIFEST_REL = 'Gallbladder/Glbd_01/Chip_files/GSAMD-24v1-0_20011747_A1.csv'
MANIFEST_FLAGS = '-c 9 -p 10 -n 1 -a 3 -sp 20 -sf 0 -st 2 -b 8 -nlh 8 -nlt 24'
BUILD = '37'
ID_LINK_REL = 'Gallbladder/Glbd_01/Data_Received/List_Ids_Remove.csv'
ID_FLAGS = '-s 0 -e 1 -nlh 3 -k -c 9'
QC_REFERENCE_PREFIX = 'Glbd_01'
PRE = {}
