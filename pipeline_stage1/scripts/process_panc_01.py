...
PREFIX = 'Panc_01'
STUDY_ID = 'Panc_01'
RAW_REL = 'Pancreas/Panc_01_PS1/Data_Received/Panscan1'
MANIFEST_REL = 'Pancreas/Panc_01_PS1/Chip_files/HumanHap550-2v3_B-b36.strand'
MANIFEST_FLAGS = '-c 1 -p 2 -n 0 -a 5 -sp 4 -nlh 1'
BUILD = '36'
ID_LINK_REL = 'Pancreas/Panc_01_PS1/Data_Received/LinkID_Panscan1.csv'
ID_FLAGS = '-s 0 -e 2 -nlh 1'
QC_REFERENCE_PREFIX = 'Panc_01'
PRE = {}
PART1 = {'neg': 'skip', 'chrpos': 'exclude', 'alleles': 'exclude'}
COMPLETION = {'chr': 'search', 'pos': 'search', 'strand': 'flip_pm', 'alleles': 'search'}
