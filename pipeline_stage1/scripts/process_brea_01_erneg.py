...
PREFIX = 'Brea_01_Erneg'
STUDY_ID = 'Brea_01_Erneg'
RAW_REL = 'genetics/Brea_01_Erneg/Data_Received/ERneg_build4_subjects'
MANIFEST_REL = 'genetics/Brea_01_Erneg/Chip_files/Human660W-Quad_v1_H.csv'
MANIFEST_FLAGS = '-c 9 -p 10 -n 1 -a 3 -sf 0 -st 2 -sp 21 -b 8 -nlh 8 -nlt 24'
BUILD = '37'
ID_LINK_REL = 'genetics/Brea_01_Erneg/Data_Received/GWAS_idepic_IDkey.txt'
ID_FLAGS = '-s 0 -e 1 -nlh 1 -q'
QC_REFERENCE_PREFIX = 'Brea_01_Erneg'
PRE = {}
PART1 = {'neg': 'exclude_FR', 'chrpos': 'exclude', 'alleles': 'exclude'}
COMPLETION = {'chr': 'search', 'pos': 'search', 'strand': 'flip_fr_pm', 'alleles': 'search'}
