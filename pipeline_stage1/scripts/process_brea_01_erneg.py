...
RAW_REL = 'Breast/Brea_01_Erneg/Data_Received/ERneg_build4_subjects'
MANIFEST_REL = 'Breast/Brea_01_Erneg/Chip_files/Human660W-Quad_v1_H.csv'
MANIFEST_FLAGS = '-c 9 -p 10 -n 1 -a 3 -sf 0 -st 2 -sp 21 -b 8 -nlh 8 -nlt 24'
BUILD = '37'
ID_LINK_REL = 'Breast/Brea_01_Erneg/Data_Received/GWAS_idepic_IDkey.txt'
