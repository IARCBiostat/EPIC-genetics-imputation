...
PREFIX = 'Ecvd_02'
STUDY_ID = 'Ecvd_02'
RAW_REL = 'genetics/Ecvd_02/Data_Received/EPICCVD_Metabo_CVDcases_for_IARC'
MANIFEST_REL = 'genetics/Ecvd_02/Chip_files/metaboplus_clean_manif_B37.csv'
MANIFEST_FLAGS = '-c 11 -p 12 -n 1 -a 3 -sp 13 -st 2 -sf 0 -b 9 -nlh 1'
BUILD = '37'
ID_LINK_REL = 'genetics/Ecvd_02/Data_Received/EPICCVD_Metabo_CVDcases_for_IARC_link_to_idepic.txt'
ID_FLAGS = '-s 1 -e 0 -nlh 1 -q'
QC_REFERENCE_PREFIX = 'Ecvd_02'
PRE = {'reset_positions': True, 'second_qc_mode': 'a'}
PART1 = {'neg': 'exclude_TB', 'chrpos': 'exclude', 'alleles': 'exclude_same', 'unknown': 'PM'}
