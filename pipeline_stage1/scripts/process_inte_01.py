...
PREFIX = 'Inte_01'
STUDY_ID = 'Inte_01'
RAW_REL = 'Interact/Inte_01/Data_Received/InterAct_Illumina660_cleaned'
MANIFEST_REL = 'Interact/Inte_01/Chip_files/Human660W-Quad_v1_H.csv'
MANIFEST_FLAGS = '-c 9 -p 10 -n 1 -sp 21 -a 3 -st 2 -sf 0 -b 8 -nlh 8 -nlt 24'
BUILD = '36'
ID_LINK_REL = None
ID_FLAGS = '-c 9 -q'
QC_REFERENCE_PREFIX = 'Inte_01'
PRE = {}
PART1 = {'neg': 'exclude_PM', 'chrpos': 'move', 'alleles': 'exclude'}
